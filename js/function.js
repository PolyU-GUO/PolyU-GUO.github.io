...
function timeElapse(date) {
	...
	var result = "<span class=\"digit\">"+ years + "</span> 年 <span class=\"digit\">"+months + "</span> 月 <span class=\"digit\">"+ days + "</span> 天 <span class=\"digit\">" + hours + "</span> 小时 <span class=\"digit\">" + minutes + "</span> 分钟 <span class=\"digit\">";
